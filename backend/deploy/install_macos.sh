#!/usr/bin/env bash
# Instala Martix como un LaunchDaemon de macOS: arranca con el sistema
...
sed \
    ...
    "$BACKEND_DIR/deploy/com.martix.app.plist.template" > "$TMP_PLIST"
...
echo "Logs:        tail -f \"$BACKEND_DIR/martix.log\""
